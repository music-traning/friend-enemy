...
const frenemyData = {
  ...
  "types": {
    "OIJP": {
      ...
      "action_plan": { "ja": "他者の光が眩しいほど、自身の影が濃くなる不条理を受け入れましょう。相手を過剰に褒める行動は、自己防衛の裏返しです。" }
    },
    "OIJT": {
      ...
      "action_plan": { "ja": "相手を自身のシナリオに強制参加させるのをやめましょう。他人の人生はあなたの舞台ではありません。" }
    },
    "OIVP": {
      ...
      "action_plan": { "ja": "宿主がいなければ枯れる生き方に限界があります。他者の因果に乗るのではなく、自らの力で根を張る覚悟が必要です。" }
    },
    "OIVT": {
      ...
      "action_plan": { "ja": "他者を引きずり下ろすことで得た高みは、砂上の楼閣です。実体のない優越感に依存する自己の脆さに気づきましょう。" }
    },
    "ODJP": {
      ...
      "action_plan": { "ja": "遠くから他者の成功を呪う時間は、自身の人生の浪費です。冷めた視線を自分自身の研鑽に向け直してください。" }
    },
    "ODJT": {
      ...
      "action_plan": { "ja": "他者の失墜によって得られる安心感は一時的な麻酔に過ぎません。自身の渇きは、他者の血では癒えないと知るべきです。" }
    },
    "ODVP": {
      ...
      "action_plan": { "ja": "人間関係をファストフードのように消費する態度は、最終的に完璧な孤独を招きます。持続可能な繋がりを模索してください。" }
    },
    "ODVT": {
      ...
      "action_plan": { "ja": "絶対的な高みから世界を見下ろす虚無感。その凍てついた心を溶かすのは、論理ではなく泥臭い情熱かもしれません。" }
    },
    "CIJP": {
      ...
      "action_plan": { "ja": "影絵芝居で他者を操ることに執着するあまり、自身の人生の主役の座を放棄していることに気づくべきです。" }
    },
    "CIJT": {
      ...
      "action_plan": { "ja": "暗闇でナイフを研ぐような生き方は、自身の精神をも蝕みます。光の当たる場所で正々堂々と意見を戦わせる勇気を持ちましょう。" }
    },
    "CIVP": {
      ...
      "action_plan": { "ja": "他者の王冠の影に隠れて生きることをやめましょう。あなた自身の名で勝負する時が来ています。" }
    },
    "CIVT": {
      ...
      "action_plan": { "ja": "複雑に絡み合った人間関係の糸は、いつかあなた自身の首を絞めます。不条理なゲームから降りる決断を。" }
    },
    "CDJP": {
      ...
      "action_plan": { "ja": "他者の不幸を待つだけの人生は、完全な停滞です。呪いのエネルギーを、自己の成長エンジンに変換してください。" }
    },
    "CDJT": {
      ...
      "action_plan": { "ja": "石を投げて隠れる行為は、自身の臆病さの証明です。その冷徹な分析力をもっと建設的な目的に使用してください。" }
    },
    "CDVP": {
      ...
      "action_plan": { "ja": "感情を排した機械的なネットワーク構築は効率的ですが、不測の事態に誰もあなたを助けないというバグを孕んでいます。" }
    },
    "CDVT": {
      ...
      "action_plan": { "ja": "他者を嘲笑うことで保たれる孤高は、ただの牢獄です。泥にまみれても何かに執着する美しさを知るべきです。" }
    }
  }
};
// 注: heroDataという変数名で参照されていた場合は、frenemyDataに変更するか、
// 呼び出し元の変数名を合わせる必要があります。（ここでは元に合わせてheroDataと置換可能に設定してもOKです）
window.heroData = frenemyData; // 既存コードの修正を最小にするための措置